...
from EmiliaAnimeBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          ...
                          dispatcher, StartTime, telethn, updater, pgram, sex)
...
STICKERS = (
      "CAACAgEAAx0CXss_8QABAVFXYV6sAtCltVRQAAEvBOxRaeq66gOoAAJCAQACASXxRgl19CCAe6SQIQQ",
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[💖 I'm Alive Now 💖](https://telegra.ph/file/e74bb8ebb7025de7857bf.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(

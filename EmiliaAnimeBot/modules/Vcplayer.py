...
Assistant username:- @YuukiXMusic
 
 Setting up 
1) Make bot admin
2) Start a voice chat
3) Try `/play [song name]` for the first time by an admin
) If userbot joined enjoy music, If not add @YuukiXMusic to your group manually and retry
 Commands:
...
• More tools 📲
  ...
  `/userbotjoin`: Invite @GokuMusicHelper to your chat

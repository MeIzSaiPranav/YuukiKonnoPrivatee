...
from EmiliaAnimeBot.function.pluginhelpers import get_text, admins_only
...
async def logogen(client, message):
    ...
    try:
        ...
        typeo = "name"
        await pablo.edit(
             "Give name and type for logo Idiot. like `/rlogo Yuuki`")
    name = lmao[0]
    mainne(name, typeo)
    caption = "<b>Logo Generated By  @YuukiKonnoRobot.<b>"
    pate = "logobyyuuki.jpg"
